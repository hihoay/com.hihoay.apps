...
//            ratingBar.setVisibility(GONE);
    ...
    public String getTemplateTypeName() {
        if (templateType == R.layout.admob_medium_template_view) {
            return MEDIUM_TEMPLATE;
        } else if (templateType == R.layout.admob_small_template_view) {
        ...
        try {
            templateType =
                    attributes.getResourceId(
                            R.styleable.TemplateView_gnt_template_type, R.layout.admob_medium_template_view);
        } finally {
            attributes.recycle();
        }
